...
-- easy goto buffer
keymap.set('n', '<F25>', ':LualineBuffersJump! 1<cr>')
keymap.set('n', '<F26>', ':LualineBuffersJump! 2<cr>')
keymap.set('n', '<F27>', ':LualineBuffersJump! 3<cr>')
keymap.set('n', '<F28>', ':LualineBuffersJump! 4<cr>')
keymap.set('n', '<F29>', ':LualineBuffersJump! 5<cr>')
keymap.set('n', '<F30>', ':LualineBuffersJump! 6<cr>')
keymap.set('n', '<F31>', ':LualineBuffersJump! 7<cr>')
keymap.set('n', '<F32>', ':LualineBuffersJump! 8<cr>')
keymap.set('n', '<F33>', ':LualineBuffersJump! 9<cr>')
keymap.set('n', '<F34>', ':LualineBuffersJump! 10<cr>')
